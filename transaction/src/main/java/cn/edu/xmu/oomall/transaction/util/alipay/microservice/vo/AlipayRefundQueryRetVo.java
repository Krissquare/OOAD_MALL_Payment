...
public class AlipayRefundQueryRetVo {
    ...
    public AlipayRefundQueryRetVo(String outTradeNo, String outRequestNo, Long totalAmount, Long refundAmount, String refundStatus, LocalDateTime gmtRefundPay) {
    ...
    public AlipayRefundQueryRetVo(AlipayReturnNo alipayReturnNo) {
        this.code="40004";
