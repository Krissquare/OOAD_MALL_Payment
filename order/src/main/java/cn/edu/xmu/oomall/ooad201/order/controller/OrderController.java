...
import cn.edu.xmu.oomall.ooad201.order.model.vo.OrderVo;
...
public class OrderController {
    ...
    @Audit
    public Object confirmOrder(@PathVariable("id") Long id, @LoginUser Long loginUserId, @LoginName String loginUserName)
    {
